	...
	cubeModel_({1,2,0})
{
	...
	cubeModel_.AddCubeTo("larm", std::make_shared<Cube>(Cube(gfx, input, "alexarm", rl)), { 0.09375,0.375,0.125 }, { -0.09375,-0.375,0 });
	
	cubeModel_.AddNodeTo("body", "rarm", { 0.25,0,0 });
	cubeModel_.AddCubeTo("rarm", std::make_shared<Cube>(Cube(gfx, input, "alexarm", rl)), { 0.09375,0.375,0.125 }, { 0.09375,-0.375,0 });
